...
onMount(async () => {
  ...
  try {
    const res = await fetch(`https://directus.ckx.app/items/Cars/${id}`);
...
{:else if car}
  <div class="max-w-xl mx-auto p-4">
    ...
    <img src={`https://directus.ckx.app/assets/${car.image}`} alt={car.marque} class="w-full h-64 object-cover rounded mb-4" />
    <ul class="mb-4">
